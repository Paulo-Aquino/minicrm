...
var route_delete = '{{url('company')}}';

$("#listado_1").DataTable({
  processing: true,
            serverSide: true,
            ajax: '{{ route('company.serverside') }}',
            columnDefs: [{
                targets: [0, 1, 2],
    ...
    "columns" : [
       ...
       { "data" : "updated_at" },
       { "data" : function(x){
           btn_edit = ` <a class="btn btn-warning btn-sm" href="{{url('/')}}/company/${x.id}/edit"  role="button"><svg class="bi bi-pen" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                 ...
                                 <a class="btn btn-info btn-sm" href="{{url('/')}}/company/${x.id}"   role="button">
